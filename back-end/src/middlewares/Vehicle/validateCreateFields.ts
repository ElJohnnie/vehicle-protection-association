...
import { Fuel, LicenseCategory, TypeVehicle } from '../../utils/enum'
import { parseTypeVehicle } from '../../utils/mask'
...
const validateCreateFields = (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!Object.values(TypeVehicle).includes(parseTypeVehicle(type))) {
        ...
        throw new CustomError('O identificador do dono do veículo é obrigatório', 422)
